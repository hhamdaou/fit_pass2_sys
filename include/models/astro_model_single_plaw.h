...
#ifndef _ASTRO_MODEL_SINGLE_PLAW_H
#define _ASTRO_MODEL_SINGLE_PLAW_H
...
namespace NuFit
{
	...
	class astro_model_single_plaw: public astro_model_base {
		public:
			astro_model_single_plaw(double emin=0, double emax=1.e9);
			~astro_model_single_plaw() { };
