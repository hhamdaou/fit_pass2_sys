...

{
    ...
    {    
        ...
        nue_domeff_cascade -> add_simulated_point(0.9, dir + std::string("p0=0.0_p1=0.0_domeff=0.90/nue_cascade.txt"));
        nue_domeff_cascade -> add_simulated_point(1.0, baselinedir + std::string("nue_cascade.txt"), true); // this is baseline hist
        nue_domeff_cascade -> add_simulated_point(1.1, dir + std::string("p0=0.0_p1=0.0_domeff=1.10/nue_cascade.txt"));
        ...
        numu_domeff_cascade -> add_simulated_point(0.9, dir + std::string("p0=0.0_p1=0.0_domeff=0.90/numu_cascade.txt"));
        numu_domeff_cascade -> add_simulated_point(1.0, baselinedir + std::string("numu_cascade.txt"), true); // this is baseline hist
        numu_domeff_cascade -> add_simulated_point(1.1, dir + std::string("p0=0.0_p1=0.0_domeff=1.10/numu_cascade.txt"));
        ...
        nutau_domeff_cascade -> add_simulated_point(0.9, dir + std::string("p0=0.0_p1=0.0_domeff=0.90/nutau_cascade.txt"));
        nutau_domeff_cascade -> add_simulated_point(1.0, baselinedir + std::string("nutau_cascade.txt"), true); // this is baseline hist
        nutau_domeff_cascade -> add_simulated_point(1.1, dir + std::string("p0=0.0_p1=0.0_domeff=1.10/nutau_cascade.txt"));
    ...
    {    
        ...
        nue_domeff_muon -> add_simulated_point(0.9, dir + std::string("p0=0.0_p1=0.0_domeff=0.90/nue_muon.txt"));
        nue_domeff_muon -> add_simulated_point(1.0, baselinedir + std::string("nue_muon.txt"), true); // this is baseline hist
        nue_domeff_muon -> add_simulated_point(1.1, dir + std::string("p0=0.0_p1=0.0_domeff=1.10/nue_muon.txt"));
        ...
        numu_domeff_muon -> add_simulated_point(0.9, dir + std::string("p0=0.0_p1=0.0_domeff=0.90/numu_muon.txt"));
        numu_domeff_muon -> add_simulated_point(1.0, baselinedir + std::string("numu_muon.txt"), true); // this is baseline hist
        numu_domeff_muon -> add_simulated_point(1.1, dir + std::string("p0=0.0_p1=0.0_domeff=1.10/numu_muon.txt"));
        ...
        nutau_domeff_muon -> add_simulated_point(0.9, dir + std::string("p0=0.0_p1=0.0_domeff=0.90/nutau_muon.txt"));
        nutau_domeff_muon -> add_simulated_point(1.0, baselinedir + std::string("nutau_muon.txt"), true); // this is baseline hist
        nutau_domeff_muon -> add_simulated_point(1.1, dir + std::string("p0=0.0_p1=0.0_domeff=1.10/nutau_muon.txt"));
    ...
    {    
        ...
        nue_domeff_hybrid -> add_simulated_point(0.9, dir + std::string("p0=0.0_p1=0.0_domeff=0.90/nue_hybrid.txt"));
        nue_domeff_hybrid -> add_simulated_point(1.0, baselinedir + std::string("nue_hybrid.txt"), true); // this is baseline hist
        nue_domeff_hybrid -> add_simulated_point(1.1, dir + std::string("p0=0.0_p1=0.0_domeff=1.10/nue_hybrid.txt"));
        ...
        numu_domeff_hybrid -> add_simulated_point(0.9, dir + std::string("p0=0.0_p1=0.0_domeff=0.90/numu_hybrid.txt"));
        numu_domeff_hybrid -> add_simulated_point(1.0, baselinedir + std::string("numu_hybrid.txt"), true); // this is baseline hist
        numu_domeff_hybrid -> add_simulated_point(1.1, dir + std::string("p0=0.0_p1=0.0_domeff=1.10/numu_hybrid.txt"));
        ...
        nutau_domeff_hybrid -> add_simulated_point(0.9, dir + std::string("p0=0.0_p1=0.0_domeff=0.90/nutau_hybrid.txt"));
        nutau_domeff_hybrid -> add_simulated_point(1.0, baselinedir + std::string("nutau_hybrid.txt"), true); // this is baseline hist
        nutau_domeff_hybrid -> add_simulated_point(1.1, dir + std::string("p0=0.0_p1=0.0_domeff=1.10/nutau_hybrid.txt"));
