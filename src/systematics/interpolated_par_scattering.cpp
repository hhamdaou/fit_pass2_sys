...

{
    ...
    {    
        ...
        nue_scattering_cascade -> add_simulated_point(0.9, dir + std::string("s-.10/nue_cascade.txt"));
        ...
        numu_scattering_cascade -> add_simulated_point(0.9, dir + std::string("s-.10/numu_cascade.txt"));
        ...
        nutau_scattering_cascade -> add_simulated_point(0.9, dir + std::string("s-.10/nutau_cascade.txt"));
    ...
    {    
        ...
        nue_scattering_muon -> add_simulated_point(0.9, dir_muon + std::string("s-.10/nue_muon.txt"));
        ...
        numu_scattering_muon -> add_simulated_point(0.9, dir_muon + std::string("s-.10/numu_muon.txt"));
        ...
        nutau_scattering_muon -> add_simulated_point(0.9, dir_muon + std::string("s-.10/nutau_muon.txt"));
    ...
    if (std::find(analysis_names.begin(), analysis_names.end(), hybrid) != analysis_names.end())
    {
        ...
        nue_scattering_hybrid -> add_simulated_point(0.9, dir+std::string("s-.10/nue_hybrid.txt"));
        ...
        numu_scattering_hybrid -> add_simulated_point(0.9, dir+std::string("s-.10/numu_hybrid.txt"));
        ...
        nutau_scattering_hybrid -> add_simulated_point(0.9, dir+std::string("s-.10/nutau_hybrid.txt"));
