#include "../../include/systematics/interpolated_par_selfveto.h"

NuFit::interpolated_par_selfveto::interpolated_par_selfveto(std::string par_name_, std::vector<std::string> analysis_names_, const std::map<std::string, NuFit::hists*> &map_analyses): interpolated_par(par_name_, analysis_names_)

{
    ...
    {    
        ...
        NuFit::interpolated_sys *nue_selfveto_cascade = new interpolated_sys(par_name, cascade, "NuE", binsx, binsy, binsz);
        nue_selfveto_cascade -> add_simulated_point(5, dir + std::string("step5/nue_cascade.txt"));
        nue_selfveto_cascade -> add_simulated_point(100, dir + std::string("step100/nue_cascade.txt"));
        ...
        nue_selfveto_cascade -> add_simulated_point(3000, dir + std::string("step3000/nue_cascade.txt"));
        nue_selfveto_cascade -> create_correction_functions(true);

        NuFit::interpolated_sys *numu_selfveto_cascade = new interpolated_sys(par_name, cascade, "NuMu", binsx, binsy, binsz); 
        numu_selfveto_cascade -> add_simulated_point(5, dir + std::string("step5/numu_cascade.txt"));
        numu_selfveto_cascade -> add_simulated_point(100, dir + std::string("step100/numu_cascade.txt"));
        ...
        numu_selfveto_cascade -> add_simulated_point(3000, dir + std::string("step3000/numu_cascade.txt"));
        numu_selfveto_cascade -> create_correction_functions(true);

        NuFit::interpolated_sys *nutau_selfveto_cascade = new interpolated_sys(par_name, cascade, "NuTau", binsx, binsy, binsz);
        nutau_selfveto_cascade -> add_simulated_point(5, dir + std::string("step5/nutau_cascade.txt"));
        nutau_selfveto_cascade -> add_simulated_point(100, dir + std::string("step100/nutau_cascade.txt"));
        ...
        nutau_selfveto_cascade -> add_simulated_point(3000, dir + std::string("step3000/nutau_cascade.txt"));
        nutau_selfveto_cascade -> create_correction_functions(true);

        // map from flavor to correction
        std::unordered_map<std::string, NuFit::interpolated_sys *> cascade_corrections;
        cascade_corrections.insert(std::pair<std::string, NuFit::interpolated_sys *>("NuE", nue_selfveto_cascade));
        cascade_corrections.insert(std::pair<std::string, NuFit::interpolated_sys *>("NuMu", numu_selfveto_cascade));
        cascade_corrections.insert(std::pair<std::string, NuFit::interpolated_sys *>("NuTau", nutau_selfveto_cascade));
        //cascade_corrections.insert(std::pair<std::string, NuFit::interpolated_sys *>("Muon", nue_selfveto_cascade));
    ...
    {    
        ...
        NuFit::interpolated_sys *nue_selfveto_muon = new interpolated_sys(par_name, muon, "NuE", binsx, binsy, binsz);
        nue_selfveto_muon -> add_simulated_point(5, dir + std::string("step5/nue_muon.txt"));
        nue_selfveto_muon -> add_simulated_point(100, dir + std::string("step100/nue_muon.txt"));
        ...
        nue_selfveto_muon -> add_simulated_point(3000, dir + std::string("step3000/nue_muon.txt"));
        nue_selfveto_muon -> create_correction_functions(true);

        NuFit::interpolated_sys *numu_selfveto_muon = new interpolated_sys(par_name, muon, "NuMu", binsx, binsy, binsz); 
        numu_selfveto_muon -> add_simulated_point(5, dir + std::string("step5/numu_muon.txt"));
        numu_selfveto_muon -> add_simulated_point(100, dir + std::string("step100/numu_muon.txt"));
        ...
        numu_selfveto_muon -> add_simulated_point(3000, dir + std::string("step3000/numu_muon.txt"));
        numu_selfveto_muon -> create_correction_functions(true);

        NuFit::interpolated_sys *nutau_selfveto_muon = new interpolated_sys(par_name, muon, "NuTau", binsx, binsy, binsz);
        nutau_selfveto_muon -> add_simulated_point(5, dir + std::string("step5/nutau_muon.txt"));
        nutau_selfveto_muon -> add_simulated_point(100, dir + std::string("step100/nutau_muon.txt"));
        ...
        nutau_selfveto_muon -> add_simulated_point(3000, dir + std::string("step3000/nutau_muon.txt"));
        nutau_selfveto_muon -> create_correction_functions(true);

        // map from flavor to correction
        std::unordered_map<std::string, NuFit::interpolated_sys *> muon_corrections;
        muon_corrections.insert(std::pair<std::string, NuFit::interpolated_sys *>("NuE", nue_selfveto_muon));
        muon_corrections.insert(std::pair<std::string, NuFit::interpolated_sys *>("NuMu", numu_selfveto_muon));
        muon_corrections.insert(std::pair<std::string, NuFit::interpolated_sys *>("NuTau", nutau_selfveto_muon));
        //muon_corrections.insert(std::pair<std::string, NuFit::interpolated_sys *>("Muon", nue_selfveto_muon));
    ...
    if (std::find(analysis_names.begin(), analysis_names.end(), hybrid) != analysis_names.end())
    {
        ...
        NuFit::interpolated_sys *nue_selfveto_hybrid = new interpolated_sys(par_name, hybrid, "NuE", binsx, binsy, binsz);
        nue_selfveto_hybrid -> add_simulated_point(5, dir + std::string("step5/nue_hybrid.txt"));
        nue_selfveto_hybrid -> add_simulated_point(100, dir + std::string("step100/nue_hybrid.txt"));
        ...
        nue_selfveto_hybrid -> add_simulated_point(3000, dir + std::string("step3000/nue_hybrid.txt"));
        nue_selfveto_hybrid -> create_correction_functions(true);

        NuFit::interpolated_sys *numu_selfveto_hybrid = new interpolated_sys(par_name, hybrid, "NuMu", binsx, binsy, binsz); 
        numu_selfveto_hybrid -> add_simulated_point(5, dir + std::string("step5/numu_hybrid.txt"));
        numu_selfveto_hybrid -> add_simulated_point(100, dir + std::string("step100/numu_hybrid.txt"));
        ...
        numu_selfveto_hybrid -> add_simulated_point(3000, dir + std::string("step3000/numu_hybrid.txt"));
        numu_selfveto_hybrid -> create_correction_functions(true);

        NuFit::interpolated_sys *nutau_selfveto_hybrid = new interpolated_sys(par_name, hybrid, "NuTau", binsx, binsy, binsz);
        nutau_selfveto_hybrid -> add_simulated_point(5, dir + std::string("step5/nutau_hybrid.txt"));
        nutau_selfveto_hybrid -> add_simulated_point(100, dir + std::string("step100/nutau_hybrid.txt"));
        ...
        nutau_selfveto_hybrid -> add_simulated_point(3000, dir + std::string("step3000/nutau_hybrid.txt"));
        nutau_selfveto_hybrid -> create_correction_functions(true);

        // map from flavor to correction
        std::unordered_map<std::string, NuFit::interpolated_sys *> hybrid_corrections;
        hybrid_corrections.insert(std::pair<std::string, NuFit::interpolated_sys *>("NuE", nue_selfveto_hybrid));
        hybrid_corrections.insert(std::pair<std::string, NuFit::interpolated_sys *>("NuMu", numu_selfveto_hybrid));
        hybrid_corrections.insert(std::pair<std::string, NuFit::interpolated_sys *>("NuTau", nutau_selfveto_hybrid));
        //hybrid_corrections.insert(std::pair<std::string, NuFit::interpolated_sys *>("Muon", nue_selfveto_hybrid));
...
NuFit::interpolated_par_selfveto::~interpolated_par_selfveto() { }
